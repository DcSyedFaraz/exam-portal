...
<div class="min-h-screen flex">
    ...
    <div class="hidden lg:flex w-1/2 bg-yellow-400 flex-col items-center justify-center p-12">
        ...
        {{-- Contact info --}}
        <div class="mt-10 border-t border-gray-900/10 pt-6 space-y-2 text-gray-800">
            <div class="flex items-center gap-3 text-sm">
                <svg class="w-4 h-4 text-gray-900 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                Dodoma, Tanzania
            </div>
            <div class="flex items-center gap-3 text-sm">
            ...
            <div class="flex items-center gap-3 text-sm">
                <svg class="w-4 h-4 text-gray-900 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
