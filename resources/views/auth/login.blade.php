            ...
            <div class="mt-10 w-full max-w-sm border-t border-gray-900/15 pt-6">
                ...
                <div class="rounded-xl border border-gray-900/15 bg-gray-900/6 px-4 py-4 space-y-3.5 shadow-sm">
                    <div class="flex items-start gap-3 text-sm text-gray-900">
                        <span class="mt-0.5 inline-flex shrink-0 rounded-md bg-gray-900/10 p-1.5 text-gray-900"
                            aria-hidden="true">
                    ...
                    <div class="flex items-start gap-3 text-sm">
                        ...
                        <div class="flex flex-col gap-1.5 font-medium">
                            <a href="tel:+255744950150"
                                class="text-gray-900 underline decoration-gray-900/30 underline-offset-2 hover:decoration-gray-900">+255
                                744 950 150</a>
