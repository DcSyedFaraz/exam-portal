...
@section('content')
    <div class="flex flex-col lg:flex-row lg:h-screen lg:overflow-hidden min-h-screen">
        ...
        <div class="hidden lg:flex w-1/2 bg-yellow-400 flex-col items-center justify-center px-10 py-6 overflow-y-auto">
            <span class="text-5xl mb-2">{{ config('app_settings.logo_icon') }}</span>
            <h1 class="text-2xl font-bold font-heading text-gray-900 text-center">{{ config('app_settings.name') }}</h1>
            <p class="text-gray-700 mt-1 text-sm text-center">{{ config('app_settings.tagline') }}</p>

            <div class="mt-5 space-y-1.5 text-gray-800 w-full max-w-sm">
                {{-- Live features --}}
            ...
            {{-- Contact info --}}
            <div class="mt-4 w-full max-w-sm border-t border-gray-900/15 pt-3">
                <p class="text-[10px] font-semibold uppercase tracking-widest text-gray-700 mb-2">Contact</p>
                <div class="rounded-xl border border-gray-900/15 bg-gray-900/6 px-3 py-3 space-y-2.5 shadow-sm">
                    <div class="flex items-start gap-2.5 text-xs text-gray-900">
                        <span class="mt-0.5 inline-flex shrink-0 rounded-md bg-gray-900/10 p-1 text-gray-900"
                            aria-hidden="true">
                    ...
                    <div class="flex items-start gap-2.5 text-xs">
                        ...
                        <a href="mailto:info@rmstechnology.co.tz"
                            class="font-medium text-gray-900 break-all underline decoration-gray-900/30 underline-offset-2 hover:decoration-gray-900">info@rmstechnology.co.tz</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        {{-- Right Panel --}}
        <div class="w-full lg:w-1/2 flex flex-col lg:items-center lg:justify-center bg-white lg:overflow-y-auto">

            {{-- Mobile logo --}}
            <div class="lg:hidden bg-yellow-400 py-5 text-center w-full">
            ...
            <div class="w-full max-w-md p-6 lg:p-0 lg:max-w-md">
                ...
                <form id="form-staff" method="POST" action="{{ route('login') }}" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="email" name="email" value="{{ old('email') }}"
                            class="form-input @error('email') border-red-400 @enderror" placeholder="admin@exam.com"
                            autocomplete="email">
                        @error('email')
                ...
                <form id="form-student" method="POST" action="{{ route('login') }}" class="space-y-4 hidden">
                    ...
                    <div>
                        ...
                        <input type="password" name="pin" class="form-input" placeholder="••••" maxlength="4"
                ...
                <div class="lg:hidden mt-8 pt-8 border-t border-gray-200">
                    <div class="rounded-xl border border-yellow-200 bg-yellow-50 px-4 py-4 mb-6">
                        <p class="text-sm text-gray-900 leading-relaxed">
                            Mtoto akipewa simu au iPad, tusimwache atumie muda wote kwenye vitu visivyo na faida 📱❌
                        </p>
                        <p class="text-sm text-gray-900 leading-relaxed mt-3">
                            Msajili mtoto wako kwenye Online Exam Portal yetu afanye mitihani, mazoezi na kujisomea popote alipo 📚💻
                        </p>
                        <p class="text-sm text-gray-900 leading-relaxed mt-3 font-medium">
                            Tuitumie internet kwa elimu na maendeleo ya watoto wetu 😊
                        </p>
                    </div>
                    ...
                    <div class="mt-6">
                        ...
                        <div class="rounded-xl border border-gray-200 bg-gray-50 px-4 py-4 space-y-3.5 shadow-sm">
                            <div class="flex items-start gap-3 text-sm text-gray-900">
                                <span class="mt-0.5 inline-flex shrink-0 rounded-md bg-gray-200/80 p-1.5 text-gray-900"
                                    aria-hidden="true">
                            ...
                            <div class="flex items-start gap-3 text-sm">
                                ...
                                <a href="mailto:info@rmstechnology.co.tz"
                                    class="font-medium text-gray-900 break-all underline decoration-gray-900/30 underline-offset-2">info@rmstechnology.co.tz</a>
                            </div>
                        </div>
                    </div>
                </div>
